                ...
                <form action="" id="m_form" method="POST"
                    ...
                    <div class="modal-body">
                        ...
                        <select id="m_link_type" class="form-control" name="type">
                            ...
                            <option value="page">Вибрати сторінку</option>
                        </select><br>
                        <div id="m_url_type">
                        ...
                        <div id="m_page_type">
                            <label for="type">Сторінка</label>
                            <select id="m_pages" class="form-control" name="page">

                                @foreach(\TCG\Voyager\Models\Page::all() as $page)
                                    <option value="{{ $page->slug }}" selected="selected"> {{ $page->title }} </option>
                                @endforeach
            ...
            $m_modal.on('show.bs.modal', function(e, data) {
                ...
                if (_adding) {
                    ...
                    if(_src.data('route') != "") {
                        ...
                        $m_url_type.hide();
                        $m_page_type.hide();
                    } else if (_src.data('page') != "" && _src.data('page') != undefined) {
                        console.log(_src.data('page'));
                        console.log(_src.data('route'));
                        $m_link_type.val('page').change();
                        $m_route_type.hide();
                        $m_url_type.hide();
                    }  else {
                        $m_link_type.val('url').change();
